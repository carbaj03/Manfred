...
enum class RoleProfileResponse private constructor(private val value: String) {
    ...
    companion object {
        private val CONSTANTS = HashMap<String, RoleProfileResponse>()
        ...
        fun fromValue(value: String): RoleProfileResponse {
            val constant = CONSTANTS[value]
            return constant ?: throw IllegalArgumentException(value)
        }
    }

    fun toDomain() = RoleProfile(value)
}
